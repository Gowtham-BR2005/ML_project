...
print(f"All available devices: {physical_devices}")
...
if gpus:
    ...
    try:
        ...
        # Optional: Set visible devices (use all GPUs)
        tf.config.set_visible_devices(gpus, 'GPU')
        
        logical_gpus = tf.config.list_logical_devices('GPU')
        print(f"✓ {len(logical_gpus)} Logical GPU(s) configured")
    ...
    print("\nOr use Google Colab for free GPU: https://colab.research.google.com/")
